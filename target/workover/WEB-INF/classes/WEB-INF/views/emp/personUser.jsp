...
<head>
    ...
    <link href="static/lib/css/plugins/iCheck/custom.css" rel="stylesheet">
    <link href="static/lib/css/animate.min.css" rel="stylesheet">
    <link href="static/lib/css/style.min.css" rel="stylesheet">
...
<form action="<%=path%>/emp/insertEmp" method="post" class="form-inline m-t" id="addp">
...
<div class="row">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="employee_name" class="form-control" name="employee_name" placeholder="请输入员工姓名"
               maxlength="10" required
               onchange="if(/^[\u0391-\uFFE5]+$/gi.test(this.value)?true:false){return this.value;}else{alert('请输入中文');}">
    </div>
    <div class="form-group col-sm-4">
        <label for="id_number">身份证号</label>
        <input type="text" id="id_number" class="form-control" name="id_number" placeholder="请输入身份证号" maxlength="18"
               required
               onchange="if(/^[1-9]{1}[0-9]{14}$|^[1-9]{1}[0-9]{16}([0-9]|[xX])$/gi.test(this.value)?true:false){return;}else{alert('输入有误');}">
    </div>
</div>
<div class="row m-t-md">
    <div class="form-group col-sm-4">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="mobile_number" class="form-control" name="mobile_number" placeholder="请输入联系电话" required
               maxlength=11 onchange="if(/\d{11}/gi.test(this.value)?true:false){return;}else{alert('电话号码11位数');}">
    </div>
    <div class="form-group col-sm-4">
...
<div class="row m-t-md">
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="zip_code_1" class="form-control" name="zip_code_1" placeholder="请输入邮编1" maxlength=6
               onchange="if(/\d{6}/gi.test(this.value)?true:false){return this.value;}else{alert('邮编六位数');}">
    </div>
    <div class="form-group col-sm-4">
        <label for="zip_code_2">户口所在地邮编</label>
        <input type="text" id="zip_code_2" class="form-control" name="zip_code_2" placeholder="请输入邮编2" maxlength=6
               onchange="if(/\d{6}/gi.test(this.value)?true:false){return this.value;}else{alert('邮编六位数');}">
    </div>
    <div class="form-group col-sm-4">
        <label for="emergency_call">紧急联系电话</label>
        <input type="text" id="emergency_call" class="form-control" name="emergency_call" placeholder="请输入紧急联系电话"
               maxlength=11 onchange="if(/\d{11}/gi.test(this.value)?true:false){return;}else{alert('电话号码11位数');}">
    </div>
</div>
<div class="row m-t-md">
    <div class="form-group col-sm-4">
        ...
        <textarea id="address" class="form-control" name="address" placeholder="请输入居住地"
                  style="resize: none;"></textarea>
    </div>
    <div class="form-group col-sm-4">
        <label for="account_location">户口所在地</label>
        <textarea id="account_location" class="form-control" name="account_location" placeholder="请输入户口所在地"
                  style="resize: none;"></textarea>
    </div>
    <div class="form-group col-sm-4">
        <label for="file_location">档案所在地</label>
        <textarea id="file_location" class="form-control" name="file_location" placeholder="请输入档案所在地"
                  style="resize: none;"></textarea>
    </div>
</div>
<div class="row m-t-md">
...
<div class="row m-t-md">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="provident_fund_number" class="form-control" name="provident_fund_number"
...
<div class="row m-t-md">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="number" id="work_experience" class="form-control" name="work_experience" min="0"
               placeholder="请输入工作年限">
    </div>
</div>
<div class="row m-t-md">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="create_by" class="form-control" name="create_by" placeholder="请输入录入人" maxlength="10"
               onchange="if(/^[\u0391-\uFFE5]+$/gi.test(this.value)?true:false){return this.value;}else{alert('请输入中文');}">
    </div>
</div>
<div class="row m-t-md">
    ...
    <div class="form-group col-sm-4">
        ...
        <input type="text" id="update_by" class="form-control" name="update_by" placeholder="请输入更新人" maxlength="10"
               onchange="if(/^[\u0391-\uFFE5]+$/gi.test(this.value)?true:false){return this.value;}else{alert('请输入中文');}">
    </div>
</div>
<div class="row m-t-md">
...
&lt;%&ndash;<script src="js/jquery.min.js?v=2.1.4"></script>&ndash;%&gt;
<script src="static/lib/js/bootstrap.min.js"></script>
<!--<script src="js/content.min.js?v=1.0.0"></script>-->
&lt;%&ndash;<script src="js/newData.js"></script>&ndash;%&gt;
<!--<script src="js/操作数据.js"></script>-->
<script src="static/lib/js/plugins/iCheck/icheck.min.js"></script>
