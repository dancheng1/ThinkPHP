package com.ky.workover.common.utils.security;
...
//        for (int i = 0; i < 100000; i++) EncodesBASE64.encodeToByte(str);
//        long e = System.nanoTime();
//        System.out.println(e - s);
        String s = "";

        byte[] bytes = EncodesBASE64.decode(s.getBytes());
